defmodule ExpoPluralForms.Known do
  @moduledoc false

  alias ExpoPluralForms.Parser
  ...
  @doc false
  @spec known_plural_forms :: %{String.t() => ExpoPluralForms.t()}
  ...
  @spec plural_form(iso_language_tag :: String.t()) :: {:ok, ExpoPluralForms.t()} | :error
