defmodule ExpoPluralForms.Evaluator do
  @moduledoc false
  ...
  @spec index(plural_forms :: ExpoPluralForms.plural(), n :: non_neg_integer()) ::
          non_neg_integer()
  def index(plural, n)
  ...
  @spec compile_index(plural_forms :: ExpoPluralForms.plural()) :: Macro.t()
